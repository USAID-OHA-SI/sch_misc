...
# EXPORT CVS FILES --------------------------------------------------------
write.csv(global_stock_df, "C:/Users/mhartig/Documents/COP21/Supply Planning Tool/ConsolidatedSPTfiles/global_stock_data.csv", row.names = FALSE)
write.csv(global_procure_df, "C:/Users/mhartig/Documents/COP21/Supply Planning Tool/ConsolidatedSPTfiles/global_procure_data.csv", row.names = FALSE)
